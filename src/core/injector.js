...
# All container names, ports and the compose project name are env-overridable
# so that a single host can run multiple stacks side-by-side (production +
# manual install simulation + integration test) without colliding.
#
# Common overrides:
